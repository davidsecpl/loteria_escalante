export const FIREBASE_REALTIME_DB_URL = "https://loteria-bbf97-default-rtdb.firebaseio.com/";
export const FIREBASE_API_KEY = "AIzaSyCvhVcsBPY8K8-LzjvtkCXeJ9lEGrKz4F8";
